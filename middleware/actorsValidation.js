...
const actorValidationRules = () => [
    ...
    body('filmography').optional().isArray().withMessage('Filmography must be an array of movie IDs')
        .custom((filmography) => filmography.every(id => typeof id === 'string')).withMessage('Each movie ID must be a string')
];
